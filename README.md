...
Populations: National, Rural, and Urban population counts.

Water Access Levels: Percentage of population with Basic, Limited, Unimproved, and Surface water access.

Income Groups: Economic classification of each country.
...
Displayed the R 
2
  value on the chart to assess goodness-of-fit.
...
💡 Key Findings
Rural Focus is Key: The data proves that urban improvements have diminishing returns. The fastest way to improve National statistics is to target Rural infrastructure.

Inequality by Income: Low-income nations show the widest spread in performance, suggesting that funding and policy effectiveness vary more than in high-income nations.

The "S-Curve": Progress is not linear. Countries start slow, accelerate rapidly during development (high ARC), and plateau once they reach ~95% access.
